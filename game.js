...
function renderGame() {
  ...
  if (playerTotal <= 20) {
    message.textContent =
      "Do you want to draw a new card? Or STAND to be safe?";
    ...
    message.textContent =
      "You're out of the game! Press 'Next Round' to play again";
    didWin = false;
    document.getElementById("newCard-btn").disabled = true;
    document.getElementById("stand-btn").disabled = true;
    document.getElementById("reset-btn").disabled = false;
...
function getNewCard() {
  ...
  if (playerTotal <= 20 && newCard === 1) {
    message.textContent =
      "You drew an Ace!  Please specify if you'd like a 1 or an 11";
